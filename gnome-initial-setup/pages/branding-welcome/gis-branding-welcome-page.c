...
struct _GisBrandingWelcomePagePrivate {
  GtkWidget *branding_title;
  GtkWidget *branding_text;
  GtkWidget *branding_logo;
  gchar *title;
  gchar *description;
  gchar *logo_path;
...
read_config_file (GisBrandingWelcomePage *page)
{
  ...
  /* This reads the keyfile containing vendor customization options. This code
   * will look for options under the "Welcome" group, and supports the following
   * keys:
...
gis_branding_welcome_page_class_init (GisBrandingWelcomePageClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (GTK_WIDGET_CLASS (klass), "/org/gnome/initial-setup/gis-branding-welcome-page.ui");

  gtk_widget_class_bind_template_child_private (GTK_WIDGET_CLASS (klass), GisBrandingWelcomePage, branding_title);
  gtk_widget_class_bind_template_child_private (GTK_WIDGET_CLASS (klass), GisBrandingWelcomePage, branding_text);
  gtk_widget_class_bind_template_child_private (GTK_WIDGET_CLASS (klass), GisBrandingWelcomePage, branding_logo);
